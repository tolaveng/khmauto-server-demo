...
namespace Data.Domain.Repositories
{
    public class CustomerRepository : ICustomerRepository
    {
        ...
        {
            var customer = context.Customers.FirstOrDefault(z => z.CustomerId == id);
        ...
        {
            return await context.Customers.FirstOrDefaultAsync(z => z.FullName.Equals(name));
        }

        public async Task<Customer> GetById(long id)
        {
            return await context.Customers.SingleOrDefaultAsync(z => z.CustomerId == id);
        }
